...
public class StudentPerformanceSummaryLiferay {
...
//			element = driver.findElement(By.xpath("//li["+chapterIndex+"]/div/div[2]/ul/li["+list+"]/div/div/div[3]"));
		...
		element = driver.findElement(By.xpath("//li["+list+"]/div/div/div[3]/a"));	
...
public static WebElement percentageLink(WebDriver driver, int percentage, int q){


element = driver.findElement(By.xpath(".//*[@id='scores-table_wrapper']/div[2]/div[1]/div[2]/table/tbody/tr["+percentage+"]/td[2]/a"));
	
//element = driver.findElement(By.xpath("//div[@id='scores']/div/div[2]/div[3]/div[2]/table/tbody/tr["+percentage+"]/td["+(q+2)+"]/a"));
...
public static int noOfChapters(WebDriver driver,int list1){

//    int	element = driver.findElements(By.xpath("//li["+list1+"]/div/div[2]/ul/li[*]/div/div/a")).size();
    
    int element = driver.findElements(By.xpath("//li["+list1+"]/div/div[2]/ul/li[*]/div/div/div[3]")).size();
...
public static int studentPerformanceLength(WebDriver driver){
	...
	public static int sizeOfExams(WebDriver driver){
		...
		int element = driver.findElements(By.xpath("//div[@id='scores']/div/div[2]/div[3]/div/div/table/thead/tr/th[*]/div/a")).size();
...
public static WebElement clickOnExam(WebDriver driver,int chapter){
		...
		element = driver.findElement(By.xpath("//div[@id='scores']/div/div[2]/div[3]/div/div/table/thead/tr/th["+chapter+"]/div/a"));
		Coordinates coordinate = ((Locatable)element).getCoordinates(); 
		coordinate.onPage(); 
		coordinate.inViewPort();
		return element;
...
int element = driver.findElements(By.xpath("//div[@id='scores']/div/div[2]/div[2]/div[2]/table/tbody/tr[*]/td")).size();
return element;
...
element = driver.findElement(By.xpath("//div[@id='scores']/div/div[2]/div[3]/div[2]/table/tbody/tr["+student+"]/td["+exams+"]/a"));
return element;
...
public static int linkTextDropdownIsPresent(WebDriver driver){
	...
	public static int questionsPresentSizeLinkText(WebDriver driver){


	 //int element =driver.findElements(By.xpath(".//table/tbody/tr[1]/td[2]/form/table/tbody/tr[1]/td/div")).size();
		int element =driver.findElements(By.xpath(".//div[2]/table/tbody/tr[1]/td[1]")).size();
			return element;

			}
	public static int hiddenQuestions(WebDriver driver){


		 //int element =driver.findElements(By.xpath(".//table/tbody/tr[1]/td[2]/form/table/tbody/tr[1]/td/div")).size();
			int element =driver.findElements(By.xpath(" //*[contains(@class, 'item hidden')]")).size();
				return element;

				}
	public static WebElement numberOfQuestionLinkText(WebDriver driver)
	{
		element =driver.findElement(By.xpath(".//*[starts-with(@id,'AIit')]/table/tbody/tr[1]/td[1]"));
		return element;


		}
	public static WebElement displayExamName(WebDriver driver,int id)
	{
		element =driver.findElement(By.xpath("//div[@id='scores-table_wrapper']/div[2]/div[3]/div/div/table/thead/tr/th["+id+"]/div/a"));
		return element;


		}
	public static WebElement DNDQuestions(WebDriver driver)
	{
		
		 element=driver.findElement(By.xpath(".//*[starts-with(@id,'UAAIit')]/table/tbody/tr/td[1]"));
	return element;
