...
{
//		AssessmentAt100.nextbutton(driver);
		
		AssessmentAt100.clickNext(driver, (i+1)).click();
		System.out.println("Drag and Drop question");
//		break;
}
	

 else if(AssessmentAt100.checkFIB(driver))
    {
			
		System.out.println("inside FIB if condition: ");
	...
	for(int j=0;j<questSize;j++)
    {
	    ...
	    System.out.println("FIB Question found: "+jsonQues);
		ArrayList<String> corr = assessment.getCorrectAnswers();
		System.out.println("FIB Correct Answer is: "+corr.get(j));
	   ...
	   System.out.println("Exit FIB if condition: "+AssessmentAt100.checkFIB(driver));
...
//		System.out.println("inside elseif condition: "+AssessmentAt100.checkFIB(driver));
	    ...
	    for(int j=0;j<questSize;j++)
	   {
	     ...
	     if(imageString>=1)
         {
		  ...
		  {	    	 
		    System.out.println("Image Question found: " +ques.get(j)); 
			ArrayList<String> corr = assessment.getCorrectAnswers();
			System.out.println("Image Correct Answer is: "+corr.get(j));
