...
public static boolean DNDSkip(WebDriver driver){

boolean element = driver.findElements(By.xpath(" //*[@class='question']/div/div/table/tbody/tr/td[2]/form/table/tbody/tr/td/div/object[contains(@id,'Flash')]")).size() > 0;
